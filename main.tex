...
\begin{itemize}[leftmargin=*,nosep]
  ...
  \item \textbf{Block-Diagonal R-Matrix}: a sparse $O(C{+}E)$ approximation
    that extends R-matrix constraints to large DAGs (4,000+ classes)
    where the dense $O(C^2)$ matrix is infeasible.  Validated on
...
datasets with $C > 4{,}000$, storing the
